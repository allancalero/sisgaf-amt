...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        ...
        'secondary' => 'bg-white hover:bg-zinc-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75',
    ...
    ->add(match ($variant) { // Text color...
        ...
        'secondary' => 'text-zinc-800 dark:text-white',
        'danger' => 'text-white',
    ...
    ->add(match ($variant) { // Border color...
        ...
        'secondary' => 'border border-zinc-200 hover:border-zinc-200 border-b-zinc-300/80 dark:border-zinc-600 dark:hover:border-zinc-600',
         default => '',
    })
    ...
    ->add(match ($variant) { // Grouped border treatments...
        ...
        'secondary' => '[[data-flux-button-group]_&]:border-s-0 [:is([data-flux-button-group]>&:first-child,_[data-flux-button-group]_:first-child>&)]:border-s-[1px]',
    })
